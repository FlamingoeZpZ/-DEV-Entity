...
public class AddToRole extends ListenerAdapter {
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        if(args[0].equalsIgnoreCase(Data.getPrefix() + "storm" )){
            ...
            eb.setDescription("Thank you for watching " + event.getGuild().getMemberById("664308445213753366").getNickname() + " streams and supporting the " + event.getGuild().getName() +"!");
